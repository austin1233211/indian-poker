...
import { sha256, sha3_256 } from '@noble/hashes/sha3';
import { buildBn254 } from 'circomlibjs';
...
export class TrustedSetupCeremonyManager {
    ...
    private generateInitialContribution(): CeremonyContribution {
        return {
            tau: this.bn254.F.toString(this.bn254.F.random()),
            alpha: this.bn254.F.toString(this.bn254.F.random()),
            beta: this.bn254.F.toString(this.bn254.F.random()),
            gamma: this.bn254.F.toString(this.bn254.F.random()),
            delta: this.bn254.F.toString(this.bn254.F.random()),
            circuitSpecific: {}
        };
    }
